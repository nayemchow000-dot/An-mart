  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newProduct: Product = {
        id: formData.slug + '-' + Date.now(), // Generate unique ID
        ...
        status: formData.status as 'draft' | 'published' | 'unpublished',
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input 
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
                    placeholder="e.g. লাক্স ম্যাট লিপস্টিক"
                  />
                </div>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    rows={6}
                    className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary resize-y"
                    placeholder="বিস্তারিত পণ্যের তথ্য..."
                  />
                </div>
              </div>
            </div>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
                  />
                  <p className="text-xs text-gray-500 mt-1">Leave blank if no discount.</p>
                </div>
